...
export default function Login() {
  ...
  return (
    <div className=''>
        <h1 className='text-center font-black text-[30px] font-serif mt-10 text-[#E68C3A]'>LOGIN TO DASHBOARD</h1>
        <div className=' py-[60px] px-[350px]'>
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-12 border-[1px] bg-[#5B5B5B20] h-[450px] w-[650px] shadow-2xl px-[80px] '>
                ...
                ={handleSubmit(onSubmit)}  className='border-[2px] border-[#E68C3A] bg-[#E68C3A] font-medium text-[18px] w-[500px] h-[40px] text-white rounded-[15px]'>Submit</button>
            </form>
        </div>
    </div>
  )
